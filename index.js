...
if (ENVIRONMENT == 'development') {
    ...
    var FB_VERIFY_TOKEN = config.FB_VERIFY_TOKEN;
    var FB_APP_SECRET = config.FB_APP_SECRET;
    var DIAGFLOW_CLIENT_ACCESS_TOKEN = config.DIAGFLOW_CLIENT_ACCESS_TOKEN;
    var SERVER_URL = config.SERVER_URL;
} else {
    var FB_PAGE_TOKEN = process.env.FB_PAGE_TOKEN;
    var FB_VERIFY_TOKEN = process.env.FB_VERIFY_TOKEN;
    var FB_APP_SECRET = process.env.FB_APP_SECRET;
    var DIAGFLOW_CLIENT_ACCESS_TOKEN = process.env.DIAGFLOW_CLIENT_ACCESS_TOKEN;
...
var apiAiService = apiai(DIAGFLOW_CLIENT_ACCESS_TOKEN, {
    language: "en",
    requestSource: "fb"
});
...
function verifyRequestSignature(req, res, buf) {
    ...
    console.log('Verified message is from Facebook and my Page.');
}
